...
class FaqServiceClass extends BaseApiService {
  constructor() {
    super('faqs');
  }
  ...
  async getForEdit(id, options = {}) {
    ...
    if (faqId == null || faqId === '') return null;
    return this.request(`/${faqId}/edit`, { method: 'GET', omitLanguage: true, ...options });
  }
